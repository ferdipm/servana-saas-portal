    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
          <div
            className="bg-gradient-to-br from-zinc-900 to-zinc-800 border border-zinc-700 rounded-2xl max-w-lg w-full p-6 shadow-2xl animate-fade-in"
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium text-zinc-300 mb-2">¿Qué muestra?</h4>
                <p className="text-sm text-zinc-400 leading-relaxed">{description}</p>
              </div>

              <div>
                <h4 className="text-sm font-medium text-zinc-300 mb-2">¿Cómo interpretarlo?</h4>
                <p className="text-sm text-zinc-400 leading-relaxed">{interpretation}</p>
              </div>
            </div>
